...
from diary.services.time import DateNotCorrect, get_weekday, parse_date, parse_pagination_date
...
async def callback_schedule(callback: CallbackQuery):
    if get_weekday(datetime.datetime.today()) in ("Суббота, Воскресенье"):
