...
class BasePageEduOrbRu:
    ...
    def find_element(self, locator: Tuple[str, str], time=10):
        """
    ...
    def find_elements(self, locator: Tuple[str, str], time=10):
        """
    ...
    def go_to_login_page(self):
        "Заходит на страницу авторизации сайта https://de.edu.orb.ru/."
        return self.driver.get(self.base_login_url)

    def go_to_diary_page(self):
        "Заходит на страницу дневника учащегося сайта https://de.edu.orb.ru/."
